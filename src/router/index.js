			...
			children: [{
				...
				},
				{
					...
					children:[
						{
						path:'/lib-one',
						component:resolve => require(['../components/LibOne.vue'],resolve),	
						meta:{}
						},
						{
						path:'/lib-two',
						component:resolve => require(['../components/LibTwo.vue'],resolve),
						meta:{}
						},
						{
						path:'/lib-three',
						component:resolve => require(['../components/LibThree.vue'],resolve),
						meta:{}
						},
						{
						path:'/lib-four',
						component:resolve => require(['../components/LibFour.vue'],resolve),
						meta:{}
					    }
					]
				},
